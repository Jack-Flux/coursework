...
const utils = {
  ...
  updateBalance(user, symbol, amount) {
    return new Promise(async (res) => {
      ...
      if ((userBalance.balances[symbol] + amount) < 0) return res({ err: true, message: 'You cannot remove an amount higher than your holdings' });
